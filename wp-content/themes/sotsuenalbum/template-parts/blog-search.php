...
<div class="faq-anchorlinks">
    <ul class="flex faq-anchorlinks__tags">
        <?php foreach($tag_terms_all as $term): ?>
            <li><a href="<?php echo esc_url(get_term_link($term->slug, $tag_taxonomy));?>#s-feature"><?php echo $term->name; ?></a></li>                                <?php endforeach; ?>
    </ul>
</div>
</div>
<?php /*
<?php if(!empty($fea_terms_all)): ?>
<div id="s-feature" class="faq-anchorlinks__ttl green">特集で検索</div>
