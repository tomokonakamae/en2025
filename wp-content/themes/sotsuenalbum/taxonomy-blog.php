        ...
        <main id="cm-main">
            ...
            <div class="main-content blog-content">
                <section class="blog1">
                    ...
                    <div class="container">
                        <?php if( $current_page === 1 ): ?>
                            <p class="blog1__txt01">卒園アルバムを手作りする方や、デザインに困った方のためのお助け記事を多数更新！卒園アルバム制作のキホンのキから、アルバムづくりのプロが伝授するデザインやレイアウトのアイデアまで、どなたでも楽しめる情報が満載！<br>ソフトの操作方法や写真撮影のコツなど、ワンランク上のオシャレなページづくりに役⽴つ裏技をぜひご活用ください！</p>
                        <?php endif; ?>
                        <?php get_template_part('template-parts/blog-search'); ?>
                        <?php if( $current_page === 1 && !empty($fea_terms)): ?>
                            <h2 class="title__ttl06">特集</h2>
                            ...
                            <?php endforeach; ?>
                        <?php endif; ?>
                        <?php if($current_term->taxonomy != $fea_taxonomy): ?>
                            <h2 class="title__ttl06">新着マガジン</h2>
