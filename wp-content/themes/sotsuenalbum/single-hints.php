            ...
            <div class="main-content hints-content">
                <section class="hints__detail">
                    <div class="container">
                        ...
                        <?php else: ?>
                            <img src="<?php echo $dir;?>/assets/images/hints/img-de.jpg" alt="">
                        <?php endif; ?>
                        </div>
                        <div class="hints__contents-yellow">
                            <h3 class="hints__contents-yellow__title"><span>目 次</span></h3>
                        ...
                        <div class="btn__btn01 text-center">
                            <a href="<?php echo esc_url(get_post_type_archive_link('hints'));?>">一覧に戻る</a>
                        </div>
